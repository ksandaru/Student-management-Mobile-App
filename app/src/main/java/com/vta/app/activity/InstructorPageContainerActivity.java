...
import com.vta.app.fragment.InstructorHomeFragment;
...
public class InstructorPageContainerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Start up view
        replaceFragment(new InstructorHomeFragment());
