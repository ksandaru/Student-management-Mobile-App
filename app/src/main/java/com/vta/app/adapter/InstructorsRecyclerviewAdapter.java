...
public class InstructorsRecyclerviewAdapter extends RecyclerView.Adapter<InstructorsRecyclerviewAdapter.UsersRecyclerviewHolder> {

    Context context;
    List<Instructor> dataList;
    List<Instructor> filteredDataList;

    public InstructorsRecyclerviewAdapter(Context context, List<Instructor> dataList) {
    ...
    @NonNull
    @Override
    public InstructorsRecyclerviewAdapter.UsersRecyclerviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(context).inflate(R.layout.students_recyclerview_item, parent, false);
        return new InstructorsRecyclerviewAdapter.UsersRecyclerviewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull InstructorsRecyclerviewAdapter.UsersRecyclerviewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.btnActions.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                InstructorsFragment.studentsListItemOnClick(filteredDataList.get(position).getEmail());
            }
        });
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (Key.isEmpty()) {
                    ...
                    List<Instructor> lstFiltered = new ArrayList<>();
                    for (Instructor row : dataList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                filteredDataList = (List<Instructor>) filterResults.values;
