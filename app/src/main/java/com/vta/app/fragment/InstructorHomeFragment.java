...
public class InstructorHomeFragment extends Fragment {
    ...
    private MaterialCardView cardCources, cardStudents, cardICourceMaterials;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        cardICourceMaterials = (MaterialCardView) getView().findViewById(R.id.cardICourceMaterials);
       ...
       //  userImage = (CircleImageView) getView().findViewById(R.id.image);
        ...
        cardICourceMaterials.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
           //  gotoFragment(new StudentsFragment());
            }
